...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<a href='".$path."$this->_instance=$prev "." $ext'>Newer Posts  </a>";
		else
		    $pagination.= "<span class='disabled'>Newer Posts  </span>";   
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<a href='".$path."$this->_instance=$next"." $ext' class='blog-pager-older-link' id='Blog1_blog-pager-older-link'>  Older Posts</a>";
		else
		    $pagination.= "<span class='disabled'>  Older Posts</span>";
		    $pagination.= "</div>\n";       
		}
